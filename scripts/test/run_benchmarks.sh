...
bash "${PROJECT_ROOT}/scripts/test/eval_vstar.sh" --limit 200 --use-grit --grit-device 0 --model Qwen/Qwen2.5-VL-7B-Instruct
...
bash "${PROJECT_ROOT}/scripts/test/eval_treebench.sh" --limit 500 --use-grit --grit-device 0 --model Qwen/Qwen2.5-VL-7B-Instruct
...
bash "${PROJECT_ROOT}/scripts/test/eval_rhbench.sh" --use-grit --grit-device 0 --limit 900 --model Qwen/Qwen2.5-VL-7B-Instruct
